...
\setbeamertemplate{title page}
{
    \begin{textblock*}{200mm}(13.5cm,.5cm)
            \href{https://github.com/alexanderlerch/2023-FRSM}{\includegraphics[height=2cm,keepaspectratio]{graph/qr}}\hspace*{2ex}
    \end{textblock*}
    \vskip-10ex
    ...
    \begin{beamercolorbox}[wd=\paperwidth,ht=.4\paperheight,dp=0.6ex]{page number in head/foot}
        ...
        \end{flushright}
    \end{beamercolorbox}%
		\addreference{\hspace{32mm}\href{https://github.com/alexanderlerch/2023-FRSM}{github.com/alexanderlerch/2023-FRSM}}
}
